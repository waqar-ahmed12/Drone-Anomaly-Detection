...
#
PATCHING_CROP = (16689, 15627, 28073, 24529)   # (x0, y0, x1, y1) — tune this

# ── Separate output dirs so demo patches never mix with preloaded ones ────────
DEMO_WORKSPACE    = r"pipeline_workspace"          # same workspace
DEMO_RGB_PATCHES  = r"pipeline_workspace/Rgb_patches"   # appends into existing
DEMO_NIR_PATCHES  = r"pipeline_workspace/Nir_patches"
